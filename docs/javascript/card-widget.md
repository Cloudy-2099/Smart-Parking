...
This plugin provides two `data-api` attributes. Any element using one of the following attributes should be placed within the `.card-tools` div, which is usually in the card header. For more information about the [Cards Component](../components/cards.md), visit the card component documentation 
